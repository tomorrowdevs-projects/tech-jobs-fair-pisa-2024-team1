...
const TreeCard = ({ selectedTree, onClose, onNavigate, onOpenModal }: TreeCardProps) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full p-4 z-[500] flex flex-col justify-center items-end">
      ...
      <div
        className="flex flex-col justify-center items-center  bg-white w-full p-4 rounded-[20px] box-shadow"
      >
        <h2 className="text-2xl font-bold text-black mb-4">{selectedTree?.nome}</h2>
        <div className="flex items-center gap-8 w-full">
          ...
          <div className="w-full">
            ...
            <p className="text-[#878585] font-medium text-md">Ultima Segnalazione</p>
            ...
            <div className="flex justify-center gap-3 items-center mt-4 w-full">
              {isTreeHealthy ? (
                ...
                <>
                  ...
                  <button className="bg-[#CE6146] text-[#EFE9CE] p-2 rounded-full shadow-lg" onClick={onOpenModal}>
                    <RiToolsFill size={30} />
                  </button>
                </>
              )}
