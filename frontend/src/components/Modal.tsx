...
const Modal = ({ isOpen, setIsOpen }: ModalProps) => {
    ...
    return (
        <div id="slideover-container" className={`w-full h-full fixed inset-0 flex justify-center items-center ${isOpen ? '' : 'invisible'} z-[500]`}>
            ...
            />
            <div id="slideover" className={`w-full rounded-t-[50px] bg-white h-full absolute duration-300 ease-out transition-all p-4 ${isOpen ? 'top-20' : 'top-full'}`}>
                <div className="w-full h-[90%] flex flex-col justify-start items-center">
                    ...
                    <div className="flex flex-col w-full h-full p-2 gap-4">
                        <div className="flex flex-col justify-center gap-1">
                            ...
                            <input type="text" placeholder="Add a type..." className="border border-black outline-none p-2" onChange={(e) => handleChange("tipo", e.currentTarget.value)} />
                        </div>
                        <div className="flex flex-col justify-center gap-1">
                            <span className="font-semibold">Name</span>
                            <input type="text" placeholder="Add a name..." className="border border-black outline-none p-2" onChange={(e) => handleChange("nome", e.currentTarget.value)} />
                        </div>
                        <div className="flex flex-col justify-center gap-1">
                        ...
                        <div className="flex flex-col justify-center gap-1 h-full">
                            ...
                            <div className="border-2 border-dashed border-gray-400 bg-gray-100 w-full h-full flex justify-center items-center">
                                <p className="text-center text-gray-400">Add an image <br />(Optional)</p>
                            </div>
                        </div>
